...
import com.pbg.view.other.SystemScreenInfo;
import com.pbg.view.ui.AnimationTabHost;
...
public class HomeTabHostAcitivity extends TabActivity {
    ...
    private void init() {
        setIndicator(getString(R.string.Contacts), 0, new Intent(this, HomeContactActivity.class), R.drawable.tab_contact_selected);
        setIndicator(getString(R.string.Message), 1, new Intent(this, HomeSMSActivity.class), R.drawable.tab_sms_normal);
        setIndicator(getString(R.string.connect_pbg), 2, new Intent(this, HomeConnectPBGActivity.class), R.drawable.tab_dial_normal);
        setIndicator(getString(R.string.settings), 3, new Intent(this, HomeSettingsActivity.class), R.drawable.tab_settings_normal);
